...
syntax region htmlBold    start=/\\\@<!\(^\|\A\)\@=\*\@<!\*\*\*\@!\S/  end=/\S\\\@<!\*\@<!\*\*\*\@!\($\|\A\)\@=/  contains=@Spell,htmlBoldItalic
syntax region htmlBoldItalic contained start=/\\\@<!\(^\|\A\)\@=\<_\@<!__\@!\S/       end=/\S\\\@<!_\@<!__\@!\($\|\A\)\@=/ contains=@Spell
syntax region htmlBoldItalic start=/\\\@<!\(^\|\A\)\@=\*\@<!\*\*\*\*\@!\S/  end=/\S\\\@<!\*\@<!\*\*\*\*\@!\($\|\A\)\@=/  contains=@Spell
...
"zelhar addition to [MACRO]:
syntax match mkdMacro /^\[[A-Z]\+\]$/ 
